...
| Agent Deck | trial only: `agent-deck` in Ghostty, `tmux -L agent-deck ls`. Do not run conductor setup. Uninstall: brew uninstall the formula + tap, then drop the isolated tmux socket. |
