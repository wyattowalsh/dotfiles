...
| Root dotfiles | Plans parent directory creation and `ln -sfn` for `.zshrc`, `.p10k.zsh`, `.gitconfig`, nested agent hints, etc. | Creates missing parent directories and repairs symlinks |
