...
shell_files := "setup.sh rig/bootstrap/macos.sh rig/bootstrap/linux.sh rig/bootstrap/dev-env.sh checks/apple-text-test.sh checks/apple-text.sh checks/apps-manual-inventory.sh checks/brew-exclude-check.sh checks/chezmoi-ignore.sh checks/config-dirs-inventory.sh checks/darwin-lock.sh checks/docs-css-health.sh checks/docs-hub-parity.sh checks/docs-sensitive.sh checks/freshen-smoke.sh checks/freshen-version.sh checks/freshen-privacy.sh checks/iina-config.sh checks/iina-qol.sh checks/kopia-nightly.sh checks/linux-dev-env-rc.sh checks/mise-boundary.sh checks/rig-ecosystem-assurance.sh checks/secrets-scan.sh checks/shell-files-sync.sh checks/smoke.sh checks/stale-path-freeze.sh checks/validate-json.sh checks/yazi-config.sh checks/zsh-alias-docs.sh checks/zsh-alias-usage.sh checks/zsh-home-behavior-test.sh checks/zsh-inventory.sh checks/zsh-structure.sh checks/zsh-structure-test.sh checks/zsh-smoke-interactive.sh checks/zsh-rollback-live.sh rig/home/dot_local/bin/executable_kopia-nightly rig/home/private_dot_config/direnv/lib/layout_uv.sh"
...
check: check-hooks check-shell check-just-fmt check-mise-boundary check-zsh check-freshen check-json secrets-scan brew-exclude check-rig-ecosystem-assurance check-yazi-config check-stale-paths check-kopia-nightly check-apple-text check-iina-config check-bats check-chezmoi-ignore check-darwin-lock check-linux-dev-env-rc check-shell-files
...
# Static IINA QoL plugin, input profile, and Hammerspoon contracts (no live writes).
check-iina-config:
    ./checks/iina-config.sh

# Preview or apply IINA QoL exact-target install. Default is dry-run.
iina-qol *ARGS:
    ./checks/iina-qol.sh {{ ARGS }}
